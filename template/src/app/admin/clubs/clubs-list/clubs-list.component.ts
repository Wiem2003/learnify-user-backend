...
@Component({
    ...
    <div class="crud-page">
      ...
      <div class="table-container">
        <table class="data-table">
          ...
          <tbody>
            @for (club of paginatedClubs; track club.id) {
              <tr>
                <td>
                  <div class="club-cell">
      ...
      <div class="table-footer pagination-footer">
        <span class="table-info">{{ filteredClubs.length }} clubs</span>
  ...
  styles: [`
    ...
    .pagination-controls .icon-btn {
      ...
      height: 32px;
      border-radius: 999px;
      border: 1px solid rgba(61, 61, 96, 0.15);
      background: #fff;
      display: inline-flex;
      align-items: center;
...
export class ClubsListComponent implements OnInit {
  ...
  get totalPages(): number {
    return Math.max(1, Math.ceil(this.filteredClubs.length / this.pageSize));
  }
