...
@Component({
  ...
  styles: [`
    ...
    .badge { display: inline-block; padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; &[data-category="Workshop"] { background: rgba(16, 185, 129, 0.1); color: #10b981; } &[data-category="Competition"] { background: rgba(200, 70, 48, 0.1); color: var(--color-cta); } &[data-category="Webinar"] { background: rgba(59, 130, 246, 0.1); color: #3b82f6; } &[data-category="Cultural Event"] { background: rgba(246, 189, 96, 0.15); color: #b8860b; } }
